...
class GAN:
    ...
    def build_model(self):
        ...
        with tf.variable_scope('scope_disc'):
            real_img_logit, real_txt_logit = self.discriminator(self.real_audio, vid)
            wrong_img_logit, wrong_txt_logit = self.discriminator(self.real_audio, w_vid, reuse=True)
            gen_img_logit, gen_txt_logit = self.discriminator(self.gen_audio, vid, reuse=True)
        ...
        self.d_loss_gen = tf.reduce_mean(c_e(gen_img_logit, neg_ex))*2 + tf.reduce_mean(c_e(gen_txt_logit, neg_ex))
