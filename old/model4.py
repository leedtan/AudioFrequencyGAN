...
class GAN:
    ...
    def generator(self, z_noise, video):
        ...
        audio = ops.linear(hidden, a4 * 10, self.g_name())
        audio = reshape(audio, [bs, a8, 2, 10])
        audio = ops.lrelu(bna1(ops.deconv2d(audio, [bs, a4, 2, 400],k_h = 2, k_w = 100, d_h=2, d_w=1, name=self.g_name())))
        audio = ops.lrelu(bna2(ops.deconv2d(audio, [bs, a2, 2, 100],k_h = 2, k_w = 100, d_h=2, d_w=1, name=self.g_name())))
        audio = ops.deconv2d(audio, [bs, a, 2, 1],k_h = 2, k_w = 100, d_h=2, d_w=1, name=self.g_name())
    ...
    def discriminator(self, audio, video, reuse=False):
        ...
        a1 = ops.lrelu(ops.conv2d(audio, ddim, k_h = 2, k_w = 100, d_h = 4, d_w = 1, name='d_a1'))
        a2 = ops.lrelu(ops.conv2d(a1, ddim*2, k_h = 2, k_w = 60, d_h = 4, d_w = 1, name='d_a2'))
        a3 = ops.lrelu(ops.conv2d(a2, ddim*4, k_h = 2, k_w = 40, d_h = 4, d_w = 1, name='d_a3'))
