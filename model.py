...
class GAN:
    ...
    def generator(self, z_noise, video):
        ...
        a_g_dim  = 4000
        a = a_g_dim
        a32, a16, a8, a4, a2 = int(a/32), int(a/16), int(a/8), int(a/4), int(a/2)
        ...
        audio = ops.lrelu(bnl1(ops.linear(hidden, a16 * 10, self.g_name())))
        audio = reshape(audio, [bs, a32, 2, 10])
        g_dim = 80
        k_def = 10
        audio = ops.lrelu(bna1(ops.deconv2d(audio, [bs, a16, 2, g_dim*2],k_h = 20, k_w = 2, d_h=2, d_w=1, name=self.g_name())))
    ...
    def discriminator(self, audio, video, reuse=False):
        ...
        a1 = ops.lrelu(ops.conv2d(audio, ddim, k_h = 5, k_w = 2, d_h = 4, d_w = 1, name='d_a1'))
        a2 = ops.lrelu(ops.conv2d(a1, ddim*2, k_h = 5, k_w = 2, d_h = 4, d_w = 1, name='d_a2'))
        a3 = ops.lrelu(ops.conv2d(a2, ddim*4, k_h = 5, k_w = 2, d_h = 2, d_w = 1, name='d_a3'))
        a4 = ops.lrelu(ops.conv2d(a3, ddim*8, k_h = 5, k_w = 2, d_h = 5, d_w = 1, name='d_a4'))
        a5 = ops.lrelu(ops.conv2d(a4, ddim*16, k_h = 5, k_w = 2, d_h = 5, d_w = 1, name='d_a5'))
